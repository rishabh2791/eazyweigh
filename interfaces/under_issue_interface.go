...
func (underIssueInterface *UnderIssueInterface) Approve(ctx *gin.Context) {
	response := value_objects.Response{}
	id := ctx.Param("id")
	...
	// Return response.
	response.Status = true
	response.Message = "Under Issue Approved."
	response.Payload = updated

	ctx.JSON(http.StatusOK, response)
}

func (underIssueInterface *UnderIssueInterface) Reject(ctx *gin.Context) {
	response := value_objects.Response{}
	id := ctx.Param("id")
	...
	// Return response.
	response.Status = true
	response.Message = "Under Issue Rejected."
	response.Payload = updated
